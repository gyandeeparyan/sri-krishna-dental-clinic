...
export const metadata = {
  ...
  description:
    "Home page for Sri Krishna Dental Clinic featuring modern dental care, family-friendly treatment guidance, and quick patient contact options.",
};
          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div className="max-w-3xl space-y-7">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Badge variant="outline">Peterwar, Jharkhand</Badge>
              </div>
              ...
              <div className="space-y-5">
                ...
                <p className="section-subtitle max-w-2xl">
                  A single calm landing screen, then clear navigation into services, hygiene guidance, clinic story,
                  and contact. The design stays refined, but the site reads like a healthcare practice, not a software product.
                </p>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2 ">
                {contactCards.map(({ icon: Icon, label, value, href }) => (
                  ...
                  >
                    ...
                    <p className="mt-4 font-ui text-[11px] uppercase tracking-[0.22em] text-(--ash)">{label}</p>
            ...
            <div className="grid gap-4 sm:grid-cols-[1.05fr_0.95fr]">
              <article className="cover-frame relative min-h-[340px] overflow-hidden sm:min-h-[460px]">
                <Image
                ...
                <div className="absolute inset-x-0 bottom-0 bg-linear-to-t from-black/80 via-black/35 to-transparent p-6">
                  <p className="editorial-kicker text-white/70">Practice portrait</p>
